  ...
  findNote(req, res, function (note) {
    ...
    switch (action) {
      case 'download':
        ...
        break
      case 'edit':
        res.redirect(config.serverURL + '/' + encodeURIComponent(note.alias ? note.alias : models.Note.encodeNoteId(note.id)))
        break
      default:
...
function showPublishSlide (req, res, next) {
  ...
  findNote(req, res, function (note) {
    ...
    if ((note.alias && shortid !== note.alias) || (!note.alias && shortid !== note.shortid)) { return res.redirect(config.serverURL + '/p/' + encodeURIComponent(note.alias || note.shortid)) }
