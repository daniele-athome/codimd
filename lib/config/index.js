...
if (['filesystem', 'notable', 's3', 'minio', 'imgur', 'azure', 'lutim'].indexOf(config.imageUploadType) === -1) {
  logger.error('"imageuploadtype" is not correctly set. Please use "filesystem", "notable", "s3", "minio", "azure", "lutim" or "imgur". Defaulting to "filesystem"')
