...
import { DIAGRAM_MARGIN, SELF_SIGNAL_WIDTH } from '../drawer/BaseDrawer';
import { ACTOR_MARGIN, ACTOR_PADDING, ActorGraphic } from './ActorGraphic';
import { NoteGraphic } from './NoteGraphic';
import { NOTE_MARGIN, NOTE_OVERLAP, NOTE_PADDING, SIGNAL_MARGIN, SIGNAL_PADDING, SignalGraph, } from './SignalGraphic';
import { TITLE_MARGIN, TITLE_PADDING, TitleGraphic } from './TitleGraphic';
export class DiagramGraphic {
    constructor(drawer, diagram) {
        this.width = 0;
        this.height = 0;
        // temp var
        this.minActorHeight = 0;
        this.signalTotalHeight = 0;
    ...
    setupNoteType(note) {
        ...
        if (note.hasManyActors()) {
            const actor1 = note.actor[0];
            const actor2 = note.actor[1];
            ...
            noteGraphic.actorAGraphic = this.actors.get(note.actor.index);
        }
        this.signalGraphics.push(noteGraphic);
        return noteGraphic;
    }
    layoutWidthOfSignals() {
