...
function profiles() {
  ...
  switch (action.type) {
    ...
    case _action_types.UserTypes.RECEIVED_PROFILE:
      {
        ...
        return _objectSpread({}, state, _defineProperty({}, data.id, user));
      }
    ...
    case _action_types.UserTypes.RECEIVED_TERMS_OF_SERVICE_STATUS:
      {
        var _data = action.data || action.payload;

        return _objectSpread({}, state, _defineProperty({}, _data.user_id, _objectSpread({}, state[_data.user_id], {
          terms_of_service_id: _data.terms_of_service_id,
          terms_of_service_create_at: _data.terms_of_service_create_at
        })));
      }
