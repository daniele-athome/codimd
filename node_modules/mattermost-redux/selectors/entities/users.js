...
var getUsersByUsername
/*: (GlobalState) => UsernameMappedObjects<UserProfile>*/
= (0, _reselect.createSelector)(_common.getUsers, function (users) {
  var usersByUsername = {};
...
= (0, _reselect.createSelector)(_common.getUsers, function (users) {
  ...
  try {
    for (var _iterator = Object.keys(users).map(function (key) {
      return users[key];
...
var isCurrentUserSystemAdmin
/*: (GlobalState) => boolean*/
= (0, _reselect.createSelector)(_common.getCurrentUser, function (user) {
...
= (0, _reselect.createSelector)(_common.getMyCurrentChannelMembership, function (state) {
...
var getProfileSetInCurrentChannel
/*: (GlobalState) => Array<$ID<UserProfile>>*/
= (0, _reselect.createSelector)(_common.getCurrentChannelId, getUserIdsInChannels, function (currentChannel, channelProfiles) {
  return channelProfiles[currentChannel];
});
exports.getProfileSetInCurrentChannel = getProfileSetInCurrentChannel;
var getProfileSetNotInCurrentChannel
/*: (GlobalState) => Array<$ID<UserProfile>>*/
= (0, _reselect.createSelector)(_common.getCurrentChannelId, getUserIdsNotInChannels, function (currentChannel, channelProfiles) {
  return channelProfiles[currentChannel];
});
exports.getProfileSetNotInCurrentChannel = getProfileSetNotInCurrentChannel;
var getProfileSetInCurrentTeam
/*: (GlobalState) => Array<$ID<UserProfile>>*/
...
var getProfileSetNotInCurrentTeam
/*: (GlobalState) => Array<$ID<UserProfile>>*/
= (0, _reselect.createSelector)(function (state) {
  return state.entities.teams.currentTeamId;
...
/*: Array<UserProfile>*/
{
  ...
  if (typeof profileSet === 'undefined') {
    ...
    currentProfiles = Object.keys(profiles).map(function (key) {
      return profiles[key];
    });
  } else {
...
= (0, _reselect.createSelector)(_common.getUsers, function (state, filters) {
  return filters;
...
/*: IDMappedObjects<UserProfile>*/
{
  ...
  if (filters.role && filters.role !== '') {
    users = users.filter(function (user) {
      return user.roles && user.roles.includes(filters && filters.role || '');
    });
  }
...
var getProfilesInCurrentChannel
/*: (GlobalState) => Array<UserProfile>*/
= (0, _reselect.createSelector)(_common.getUsers, getProfileSetInCurrentChannel, function (profiles, currentChannelProfileSet) {
...
var getProfilesNotInCurrentChannel
/*: (GlobalState) => Array<UserProfile>*/
= (0, _reselect.createSelector)(_common.getUsers, getProfileSetNotInCurrentChannel, function (profiles, notInCurrentChannelProfileSet) {
...
var getProfilesInCurrentTeam
/*: (GlobalState) => Array<UserProfile>*/
= (0, _reselect.createSelector)(_common.getUsers, getProfileSetInCurrentTeam, function (profiles, currentTeamProfileSet) {
  return sortAndInjectProfiles(profiles, currentTeamProfileSet);
});
exports.getProfilesInCurrentTeam = getProfilesInCurrentTeam;
var getProfilesInTeam
/*: (GlobalState, $ID<Team>) => Array<UserProfile>*/
= (0, _reselect.createSelector)(_common.getUsers, getUserIdsInTeams, function (state, teamId) {
  return teamId;
...
var getProfilesNotInCurrentTeam
/*: (GlobalState) => Array<UserProfile>*/
= (0, _reselect.createSelector)(_common.getUsers, getProfileSetNotInCurrentTeam, function (profiles, notInCurrentTeamProfileSet) {
...
var getProfilesWithoutTeam
/*: (GlobalState, filters?: Filters) => Array<UserProfile>*/
= (0, _reselect.createSelector)(_common.getUsers, getUserIdsWithoutTeam, function (state, filters) {
  return filters;
...
/*: Array<UserProfile>*/
{
  ...
  var users = (0, _common.getUsers)(state);
  var profiles = (0, _user_utils.filterProfilesMatchingTerm)(Object.keys(users).map(function (key) {
    return users[key];
  }), term);
  var filteredProfilesMap = filterProfiles((0, _user_utils.profileListToMap)(profiles), filters);
  var filteredProfiles = Object.keys(filteredProfilesMap).map(function (key) {
    return filteredProfilesMap[key];
  });
...
/*: Array<UserProfile>*/
{
  ...
  /*:: ?: Filters*/
  = arguments.length > 3 ? arguments[3] : undefined;
  var filteredProfiles = (0, _user_utils.filterProfilesMatchingTerm)(getProfilesWithoutTeam(state, filters), term);
...
var shouldShowTermsOfService
/*: (GlobalState) => boolean*/
= (0, _reselect.createSelector)(_general.getConfig, _common.getCurrentUser, _general.getLicense, function (config, user, license) {
...
var getUsersInVisibleDMs
/*: (GlobalState) => Array<UserProfile>*/
= (0, _reselect.createSelector)(_common.getUsers, _preferences.getDirectShowPreferences, function (users, preferences) {
  var dmUsers = [];
