  ...
  return (
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee4(dispatch, getState) {
        var currentUserId, created, member, storeMember, profilesInChannel;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 13:
                ...
                storeMember = (0, _channels.getMyChannelMember)(getState(), created.id);
                ...
                _context4.prev = 17;
                _context4.next = 20;
                return _client.Client4.getMyChannelMember(created.id);
              ...
              case 23:
                ...
                dispatch((0, _errors.logError)(_context4.t1));
  ...
  return (
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee13(dispatch, getState) {
        ...
        }, _callee13, null, [[1, 12], [23, 51, 55, 63], [30, 34, 38, 46], [39,, 41, 45], [56,, 58, 62]]);
      }));
  ...
  return (
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee14(dispatch, getState) {
        ...
        }, _callee14, null, [[0, 7], [18, 46, 50, 58], [25, 29, 33, 41], [34,, 36, 40], [51,, 53, 57]]);
      }));
  ...
  return (
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee18(dispatch, getState) {
        var state, viewArchivedChannels, currentChannelId, teamId, channelsInTeam, channel;
            ...
            switch (_context18.prev = _context18.next) {
              ...
              case 12:
                ...
                if (channelId === currentChannelId && !viewArchivedChannels) {
                  ...
                  channelsInTeam = (0, _channels.getChannelsNameMapInTeam)(state, teamId);
                  channel = (0, _channel_utils.getChannelByName)(channelsInTeam, (0, _channels.getRedirectChannelNameForTeam)(state, teamId));
...
/*: ActionFunc*/
{
  ...
  var notAssociatedToGroup
  /*: string*/
  = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  var excludeDefaultChannels
  /*: boolean*/
          ...
          while (1) {
            switch (_context22.prev = _context22.next) {
              case 0:
                ...
                _context22.prev = 1;
                _context22.next = 4;
                return _client.Client4.getAllChannels(page, perPage, notAssociatedToGroup, excludeDefaultChannels);
          ...
          while (1) {
            switch (_context26.prev = _context26.next) {
              case 0:
                ...
                _context26.prev = 1;
                _context26.next = 4;
                return _client.Client4.searchAllChannels(term, notAssociatedToGroup, excludeDefaultChannels);
