  ...
  return (
    ...
    function () {
      ...
      /*: GetStateFunc*/
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 87:
                _context5.prev = 87;
                _context5.t4 = _context5["catch"](83);
              ...
              case 104:
                _context5.prev = 104;
                _context5.t5 = _context5["catch"](57);
        ...
        }, _callee5, null, [[4, 36], [17, 22, 26, 34], [27,, 29, 33], [43, 48], [57, 104, 108, 116], [64, 68, 72, 80], [73,, 75, 79], [83, 87, 91, 99], [92,, 94, 98], [109,, 111, 115]]);
      }));
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                promises = [dispatch(getMe()), dispatch((0, _preferences.getMyPreferences)()), dispatch((0, _teams.getMyTeams)()), dispatch((0, _teams.getMyTeamMembers)()), dispatch((0, _teams.getMyTeamUnreads)())]; // Sometimes the server version is set in one or the other
  ...
  return (
    ...
    function () {
      ...
      /*: GetStateFunc*/
        ...
        var profiles, receivedProfilesListActionType;
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                _context14.prev = 0;
                _context14.next = 3;
                return _client.Client4.getProfilesNotInTeam(teamId, groupConstrained, page, perPage);
              ...
              case 11:
                receivedProfilesListActionType = groupConstrained ? _action_types.UserTypes.RECEIVED_PROFILES_LIST_NOT_IN_TEAM_AND_REPLACE : _action_types.UserTypes.RECEIVED_PROFILES_LIST_NOT_IN_TEAM;
                dispatch((0, _reduxBatchedActions.batchActions)([{
...
/*: ActionFunc*/
{
  var perPage
  /*: number*/
  = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : _constants.General.PROFILE_CHUNK_SIZE;
  return (
    /*#__PURE__*/
    function () {
      ...
      /*: GetStateFunc*/
        ...
        var currentUserId, profiles, receivedProfilesListActionType;
          ...
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                ...
                _context17.prev = 2;
                _context17.next = 5;
                return _client.Client4.getProfilesNotInChannel(teamId, channelId, groupConstrained, page, perPage);
              ...
              case 13:
                receivedProfilesListActionType = groupConstrained ? _action_types.UserTypes.RECEIVED_PROFILES_LIST_NOT_IN_CHANNEL_AND_REPLACE : _action_types.UserTypes.RECEIVED_PROFILES_LIST_NOT_IN_CHANNEL;
                dispatch((0, _reduxBatchedActions.batchActions)([{
                  type: receivedProfilesListActionType,
                  data: profiles,
                  id: channelId
