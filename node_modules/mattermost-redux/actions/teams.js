  ...
  return (
    ...
    function () {
      ...
      /*: GetStateFunc*/
        ...
        }, _callee4, null, [[9, 37, 41, 49], [16, 20, 24, 32], [25,, 27, 31], [42,, 44, 48]]);
      }));
  ...
  return (
    ...
    function () {
      ...
      /*: GetStateFunc*/
        ...
        var member, actions, state, currentUserId, _state$entities$chann, channels, myMembers, _i, _Object$values, channelMember, channel;
            ...
            switch (_context9.prev = _context9.next) {
              ...
              case 10:
                ...
                if (currentUserId === userId) {
                  ...
                  for (_i = 0, _Object$values = Object.values(myMembers); _i < _Object$values.length; _i++) {
                    channelMember = _Object$values[_i];
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                currentUserId = state.entities.users.currentUserId;
                _context12.next = 7;
                return _client.Client4.addToTeam(teamId, currentUserId);
