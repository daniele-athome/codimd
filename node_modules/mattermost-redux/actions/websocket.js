  ...
  return (
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee3(dispatch, getState) {
        var state, currentTeamId, currentChannelId, currentUserId, dmPrefs, statusesToLoad, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, pref, currentTeamMembership, _ref4, data, stillMemberOfCurrentChannel, newMsg;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                state = getState();
                currentTeamId = (0, _teams2.getCurrentTeamId)(state);
                currentChannelId = (0, _channels2.getCurrentChannelId)(state);
                ...
                dmPrefs = (0, _preferences.getDirectShowPreferences)(state);
                statusesToLoad = _defineProperty({}, currentUserId, true);
                _iteratorNormalCompletion = true;
                _didIteratorError = false;
                _iteratorError = undefined;
                _context3.prev = 10;

                for (_iterator = dmPrefs[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                  pref = _step.value;
              ...
              case 26:
                ...
                _context3.next = 30;
                return dispatch((0, _teams.getMyTeams)());

              case 30:
                _context3.next = 32;
                return dispatch((0, _teams.getMyTeamMembers)());

              case 32:
                currentTeamMembership = (0, _teams2.getCurrentTeamMembership)(getState());
                ...
                _context3.next = 37;
                return dispatch((0, _channels.fetchMyChannelsAndMembers)(currentTeamId));
              ...
              case 37:
                ...
                if (data && data.members) {
                  stillMemberOfCurrentChannel = data.members.find(function (m) {
  ...
  return function (dispatch, getState) {
    ...
    if (msg.broadcast.team_id === currentTeamId) {
      if (msg.data.channel_id === currentChannelId && !viewArchivedChannels) {
        var channelsInTeam = (0, _channels2.getChannelsNameMapInTeam)(state, currentTeamId);
        var channel = (0, _channel_utils.getChannelByName)(channelsInTeam, (0, _channels2.getRedirectChannelNameForTeam)(state, currentTeamId));
...
function getAddedDmUsersIfNecessary(preferences) {
  return function (dispatch, getState) {
    ...
    for (var _i = 0, _userIds = userIds; _i < _userIds.length; _i++) {
      var userId = _userIds[_i];
