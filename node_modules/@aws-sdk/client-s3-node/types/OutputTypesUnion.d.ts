...
export declare type OutputTypesUnion = AbortMultipartUploadOutput | CompleteMultipartUploadOutput | CopyObjectOutput | CreateBucketOutput | CreateMultipartUploadOutput | DeleteBucketOutput | DeleteBucketAnalyticsConfigurationOutput | DeleteBucketCorsOutput | DeleteBucketEncryptionOutput | DeleteBucketInventoryConfigurationOutput | DeleteBucketLifecycleOutput | DeleteBucketMetricsConfigurationOutput | DeleteBucketPolicyOutput | DeleteBucketReplicationOutput | DeleteBucketTaggingOutput | DeleteBucketWebsiteOutput | DeleteObjectOutput | DeleteObjectTaggingOutput | DeleteObjectsOutput | GetBucketAccelerateConfigurationOutput | GetBucketAclOutput | GetBucketAnalyticsConfigurationOutput | GetBucketCorsOutput | GetBucketEncryptionOutput | GetBucketInventoryConfigurationOutput | GetBucketLifecycleOutput | GetBucketLifecycleConfigurationOutput | GetBucketLocationOutput | GetBucketLoggingOutput | GetBucketMetricsConfigurationOutput | GetBucketNotificationOutput | GetBucketNotificationConfigurationOutput | GetBucketPolicyOutput | GetBucketReplicationOutput | GetBucketRequestPaymentOutput | GetBucketTaggingOutput | GetBucketVersioningOutput | GetBucketWebsiteOutput | GetObjectOutput | GetObjectAclOutput | GetObjectTaggingOutput | GetObjectTorrentOutput | HeadBucketOutput | HeadObjectOutput | ListBucketAnalyticsConfigurationsOutput | ListBucketInventoryConfigurationsOutput | ListBucketMetricsConfigurationsOutput | ListBucketsOutput | ListMultipartUploadsOutput | ListObjectVersionsOutput | ListObjectsOutput | ListObjectsV2Output | ListPartsOutput | PutBucketAccelerateConfigurationOutput | PutBucketAclOutput | PutBucketAnalyticsConfigurationOutput | PutBucketCorsOutput | PutBucketEncryptionOutput | PutBucketInventoryConfigurationOutput | PutBucketLifecycleOutput | PutBucketLifecycleConfigurationOutput | PutBucketLoggingOutput | PutBucketMetricsConfigurationOutput | PutBucketNotificationOutput | PutBucketNotificationConfigurationOutput | PutBucketPolicyOutput | PutBucketReplicationOutput | PutBucketRequestPaymentOutput | PutBucketTaggingOutput | PutBucketVersioningOutput | PutBucketWebsiteOutput | PutObjectOutput | PutObjectAclOutput | PutObjectTaggingOutput | RestoreObjectOutput | SelectObjectContentOutput | UploadPartOutput | UploadPartCopyOutput;
