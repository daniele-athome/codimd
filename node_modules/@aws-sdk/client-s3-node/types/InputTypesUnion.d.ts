...
export declare type InputTypesUnion = AbortMultipartUploadInput | CompleteMultipartUploadInput | CopyObjectInput | CreateBucketInput | CreateMultipartUploadInput | DeleteBucketInput | DeleteBucketAnalyticsConfigurationInput | DeleteBucketCorsInput | DeleteBucketEncryptionInput | DeleteBucketInventoryConfigurationInput | DeleteBucketLifecycleInput | DeleteBucketMetricsConfigurationInput | DeleteBucketPolicyInput | DeleteBucketReplicationInput | DeleteBucketTaggingInput | DeleteBucketWebsiteInput | DeleteObjectInput | DeleteObjectTaggingInput | DeleteObjectsInput | GetBucketAccelerateConfigurationInput | GetBucketAclInput | GetBucketAnalyticsConfigurationInput | GetBucketCorsInput | GetBucketEncryptionInput | GetBucketInventoryConfigurationInput | GetBucketLifecycleInput | GetBucketLifecycleConfigurationInput | GetBucketLocationInput | GetBucketLoggingInput | GetBucketMetricsConfigurationInput | GetBucketNotificationInput | GetBucketNotificationConfigurationInput | GetBucketPolicyInput | GetBucketReplicationInput | GetBucketRequestPaymentInput | GetBucketTaggingInput | GetBucketVersioningInput | GetBucketWebsiteInput | GetObjectInput | GetObjectAclInput | GetObjectTaggingInput | GetObjectTorrentInput | HeadBucketInput | HeadObjectInput | ListBucketAnalyticsConfigurationsInput | ListBucketInventoryConfigurationsInput | ListBucketMetricsConfigurationsInput | ListBucketsInput | ListMultipartUploadsInput | ListObjectVersionsInput | ListObjectsInput | ListObjectsV2Input | ListPartsInput | PutBucketAccelerateConfigurationInput | PutBucketAclInput | PutBucketAnalyticsConfigurationInput | PutBucketCorsInput | PutBucketEncryptionInput | PutBucketInventoryConfigurationInput | PutBucketLifecycleInput | PutBucketLifecycleConfigurationInput | PutBucketLoggingInput | PutBucketMetricsConfigurationInput | PutBucketNotificationInput | PutBucketNotificationConfigurationInput | PutBucketPolicyInput | PutBucketReplicationInput | PutBucketRequestPaymentInput | PutBucketTaggingInput | PutBucketVersioningInput | PutBucketWebsiteInput | PutObjectInput | PutObjectAclInput | PutObjectTaggingInput | RestoreObjectInput | SelectObjectContentInput | UploadPartInput | UploadPartCopyInput;
